...
# source: https://web.archive.org/web/20180702064321/http://ibg.colorado.edu/cdrom2010/bartels/MultivariateTwinAnalysis/GenEpiHelperFunctions.R
# -----------------------------------------------------------------------
...
ADEpathMatrices <- c("ADE.a","ADE.d","ADE.e","ADE.iSD","ADE.iSD %*% ADE.a","ADE.iSD %*% ADE.d","ADE.iSD %*% ADE.e")
ADEpathLabels <- c("pathEst_a","pathEst_d","pathEst_e","iSD","stPathEst_a","stPathEst_d","stPathEst_e")

ADEcovMatrices <- c("ADE.A","ADE.D","ADE.E","ADE.V","ADE.A/ADE.V","ADE.D/ADE.V","ADE.E/ADE.V")
ADEcovLabels <- c("covComp_A","covComp_D","covComp_E","Var","stCovComp_A","stCovComp_D","stCovComp_E")
...
ACEpathMatricesInt <- c("ACE.aI","ACE.cI","ACE.eI")
ACEpathLabelsInt <- c("pathEst_aI","pathEst_cI","pathEst_eI")
